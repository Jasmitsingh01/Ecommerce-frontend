...
function CartCard() {
  return (
    <div className="p-5">
        ...
        <p className=" text-xl min-[425px]:text-2xl text-nowrap mb-3">Sub Total: $15</p>
        <p className=" text-xl min-[425px]:text-2xl text-nowrap mb-3">Shipping Price : $5</p>
        </div>
        <p className=" text-2xl min-[425px]:text-3xl mb-3">Total Payable : $20</p>

        <button className="p-3 bg-green-500 w-full rounded shadow  text-white text-lg">Checkout</button>
    </div>
  )
}
